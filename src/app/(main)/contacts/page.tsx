...
export default function ContactsPage() {
  return (
    <main className="bg-background py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-2xl mx-auto bg-card rounded-lg shadow-md p-8 border border-border">
          ...
          <div className="space-y-6">
            <div className="p-6 bg-secondary rounded-lg border border-border">
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-foreground font-medium">Адельшин Джемильхан</span>
                </div>
                <div className="flex items-center gap-3">
            ...
            <div className="p-6 bg-secondary rounded-lg border border-border">
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  <User className="w-5 h-5 text-muted-foreground shrink-0" />
                  <span className="text-foreground font-medium">Кон Владислав</span>
                </div>
                <div className="flex items-center gap-3">
                  <Send className="w-5 h-5 text-muted-foreground shrink-0" />
                  <a
            ...
            <div className="p-6 bg-secondary rounded-lg border border-border">
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  <User className="w-5 h-5 text-muted-foreground shrink-0" />
                  <span className="text-foreground font-medium">Борисов Максим</span>
                </div>
                <div className="flex items-center gap-3">
                  <Send className="w-5 h-5 text-muted-foreground shrink-0" />
                  <a
          ...
          <div className="p-6 bg-accent rounded-lg border border-border">
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                ...
                <span className="text-accent-foreground font-medium">Петров Дмитрий</span>
              </div>
              <div className="flex items-center gap-3">
                <Send className="w-5 h-5 text-accent-foreground shrink-0" />
                <a
