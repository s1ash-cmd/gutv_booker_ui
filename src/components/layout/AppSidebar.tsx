...
export function AppSidebar() {
  ...
  return (
    <Sidebar className="border-r border-border/50 bg-white/85 backdrop-blur-xl dark:bg-card/30">
      <SidebarContent className="flex flex-col bg-transparent">
        <div className="px-6 py-6 border-b border-border/30">
          <div className="relative">
            ...
            <Link
              href="/"
              className="relative flex items-center gap-3 rounded-lg border border-border/50 bg-muted/70 px-4 py-3 backdrop-blur transition-colors hover:bg-muted/90 dark:bg-card/50 dark:hover:bg-card/70"
            >
      ...
      <SidebarFooter className="p-3 border-t border-border/30 bg-transparent space-y-3">
        <Link
